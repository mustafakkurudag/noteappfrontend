        ...
        <nav className="flex items-center justify-center bg-transparent p-6">
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div className="text-sm lg:flex-grow">
                    <div className='block mt-4 lg:inline-block lg:mt-0 text-gray-700 font-bold hover:text-blue-600 mr-4'>
                        <Link to={'/teachers'} relative="path">Öğretmenler</Link>
                    </div>
                </div>
                <div className="inline-block text-sm px-4 py-2 leading-none border rounded text-gray-700 font-bold border-black hover:border-transparent hover:text-blue-600 hover:bg-white mt-4 lg:mt-0">
                    <Link to={'https://github.com/mustafakkurudag'} >Github</Link>
                </div>
            </div>
        </nav>
    </div>
